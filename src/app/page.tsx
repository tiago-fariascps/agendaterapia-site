...
import { ArrowRight, Calendar, User, Shield, Users, FileText, BarChart, Phone, Mail, MessageCircle, Star, Heart, Zap, CheckCircle, Clock, DollarSign, Target, TrendingUp, Lock, Bell, Smile, ThumbsUp, Eye, CheckSquare, Sparkles, Quote, X, Check } from 'lucide-react'
...
export default function Home() {
  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      {/* Seção: Monitor com Prints do Sistema */}
      <section className="py-24 px-8 bg-gradient-to-b from-white to-slate-50/50">
        <div className="max-w-6xl mx-auto">
          ...
          >
            <h2 className="text-3xl lg:text-4xl font-black text-slate-900/95 drop-shadow-sm mb-6">
              Interface Profissional
            </h2>
            <p className="text-lg lg:text-xl text-slate-600 max-w-2xl mx-auto leading-relaxed font-light">
              Visualize como a plataforma funciona na prática
            </p>
          </motion.div>

          <div className="relative max-w-4xl mx-auto">
            <div className="relative">
              <div className="relative bg-gradient-to-br from-slate-800/95 to-slate-900/95 rounded-2xl lg:rounded-3xl p-3 lg:p-5 shadow-2xl shadow-slate-900/20 border-2 lg:border-4 border-slate-600/80">
                <div className="relative rounded-xl lg:rounded-2xl overflow-hidden border border-slate-500/50 shadow-inner">
                  ...
                  <div className="relative w-full h-[360px] lg:h-[480px] bg-slate-900">
                    ...
                    {showImageError['dashboard-0'] && (
                      <div className="absolute inset-0 flex flex-col items-center justify-center bg-slate-900 p-8">
                        <div className="text-center">
                          ...
                          <p className="text-xl font-semibold text-white mb-2">Prints do Dashboard</p>
                          <p className="text-slate-300 text-sm mb-4">dashboard-agenda.jpg, dashboard-pacientes.jpg, etc.</p>
                          <p className="text-slate-400 text-xs">Adicione as imagens na pasta public</p>
                        </div>
                      </div>
                    )}

                    <div className="absolute bottom-0 left-0 right-0 h-20 bg-gradient-to-t from-slate-900/40 via-slate-800/20 to-transparent pointer-events-none" />
                    ...
                    <div className="absolute bottom-4 left-6 right-6 text-white z-20">
                      <div className="flex items-center justify-between">
                        ...
                        <div className="flex items-center gap-2 bg-slate-900/50 backdrop-blur-sm px-3 py-1 rounded-full">
                          <span className="text-sm font-bold">{currentSlide + 1}</span>
                          <span className="text-white/60">/</span>
                          <span className="text-white/80">{dashboardImages.length}</span>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="absolute bottom-4 left-1/2 -translate-x-1/2 flex gap-2 z-20">
                      {dashboardImages.map((_, index) => (
                        <button
                          ...
                          className={`w-2 h-2 rounded-full backdrop-blur-sm border border-white/50 transition-all duration-300 hover:scale-125 ${
                            index === currentSlide 
                              ? 'bg-slate-300 border-transparent scale-125' 
                              : 'bg-white/40'
                          }`}
              ...
              <div className="relative">
                ...
                <div className="absolute top-5 left-1/2 -translate-x-1/2 w-40 lg:w-56 h-1.5 bg-slate-900/30 blur-lg rounded-full" />
              </div>
            </div>
          </div>
        </div>
